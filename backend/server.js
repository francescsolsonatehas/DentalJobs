...
app.get("/stats/clinicas-potenciales-por-especialidad/:usuario_id", verifyToken, (req, res) => {
  db.all(
    ...
    (err, resultado) => {
      if (err) {
        console.error(err);
        return res.status(500).json({ error: "Error al obtener clínicas potenciales por especialidad" });
      }
      res.json(resultado || []);
    }
  );
...
app.get("/stats/clinicas-potenciales-por-ciudad/:usuario_id", verifyToken, (req, res) => {
  db.all(
    ...
    (err, resultado) => {
      if (err) {
        console.error(err);
        return res.status(500).json({ error: "Error al obtener clínicas potenciales por ciudad" });
      }
      res.json(resultado || []);
    }
  );
...
app.get("/stats/clinicas-potenciales-por-ciudad-especialidad/:usuario_id", verifyToken, (req, res) => {
  db.all(
    ...
    (err, resultado) => {
      if (err) {
        console.error(err);
        return res.status(500).json({ error: "Error al obtener clínicas potenciales por ciudad y especialidad" });
      }
      res.json(resultado || []);
    }
  );
...
app.get("/stats/clinicas-potenciales-especialidad-lista/:usuario_id/:especialidad", verifyToken, (req, res) => {
  db.all(
    `SELECT DISTINCT o.usuario_id, u.nombre, u.email, u.telefono, u.movil, u.direccion, u.codigo_postal, u.pais, o.ciudad
     FROM publicaciones o
     INNER JOIN usuarios u ON o.usuario_id = u.id
    ...
    [req.params.especialidad, req.params.especialidad, req.params.usuario_id],
    (err, clinicas) => {
      if (err) {
        console.error(err);
        return res.status(500).json({ error: "Error al obtener clínicas potenciales" });
...
app.get("/stats/clinicas-potenciales-ciudad-lista/:usuario_id/:ciudad", verifyToken, (req, res) => {
  db.all(
    `SELECT DISTINCT o.usuario_id, u.nombre, u.email, u.telefono, u.movil, u.direccion, u.codigo_postal, u.pais, o.ciudad
     FROM publicaciones o
     INNER JOIN usuarios u ON o.usuario_id = u.id
    ...
    [req.params.ciudad, req.params.usuario_id],
    (err, clinicas) => {
      if (err) {
        console.error(err);
        return res.status(500).json({ error: "Error al obtener clínicas potenciales" });
...
app.get("/stats/clinicas-potenciales-ciudad-especialidad-lista/:usuario_id/:ciudad/:especialidad", verifyToken, (req, res) => {
  db.all(
    `SELECT DISTINCT o.usuario_id, u.nombre, u.email, u.telefono, u.movil, u.direccion, u.codigo_postal, u.pais, o.ciudad
     FROM publicaciones o
     INNER JOIN usuarios u ON o.usuario_id = u.id
    ...
    [req.params.ciudad, req.params.especialidad, req.params.especialidad, req.params.usuario_id],
    (err, clinicas) => {
      if (err) {
        console.error(err);
        return res.status(500).json({ error: "Error al obtener clínicas potenciales" });
